...
def func(*args,e,**kwargs):
	print(args)   # (1, 2, 3, 4)  普通收集形参  打包成元组
	print(e)      # 3               命名关键字形参
	print(kwargs) # {'a': 1, 'b': 2}  关键字收集形参 打包成字典
...
"""
	普通形参 -> 默认形参 -> 普通收集形参(打包元组) -> 命名关键字形参 -> 关键字收集形参(打包字典)
"""
...
f1(1, 2, 3, 'a', 'b', x=99) # a=1 b=2 c=3 args=(a,b) kw={x:99}   #形参 打包成字典

def f2(a, b, c=0, *, d, **kw):
    print('a =', a, 'b =', b, 'c =', c, 'd =', d, 'kw =', kw)
f2(1, 2, d=99, ext=None)#a=1 b=2 c=0 d=99 kw={ext:None}  #形参 打包成字典      d是命名关键字参数
...
#形参 打包  成字典
# a=1,b=2,c=3 d=88 kw={x:#}  #d是命名关键字参数
