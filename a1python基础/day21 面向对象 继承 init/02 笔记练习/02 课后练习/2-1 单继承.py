...
obj2 = Woman()
# obj2.__makefire() #AttributeError: 'Woman' object has no attribute '__makefire'
# obj2.pub_func() #AttributeError: 'Woman' object has no attribute '_Woman__makefire'
