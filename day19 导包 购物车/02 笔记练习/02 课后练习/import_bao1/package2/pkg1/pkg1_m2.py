...
# 01 相对于当前路径找pkg1_m1模块
from . import pkg1_m1 
# 直接在这个文件执行,会报错
#ImportError: cannot import name 'pkg1_m1'
print(pkg1_m1.ceshi103) #ceshi103

# 相对于当前路径找pkg1_m1模块
# from . import pkg1_m1
# print(pkg1_m1.ceshi103)

# 02 相对于当前路径pkg1_m1模块中引入ceshi104成员
from .pkg1_m1 import ceshi104
print(ceshi104) #ceshi104

# 03找上一级中的一个模块
from .. import pkg_module1
print(pkg_module1.ceshi201) #ceshi201

# 找上一级中的一个模块里的一个成员 
from ..pkg_module1 import ceshi202
from .. pkg_module1 import ceshi202
print(ceshi202) #ceshi202

# 找上一级包中的具体某个模块
from ..pkg2 import pkg2_m2
print(pkg2_m2.ceshi300) #ceshi300
