...
try:
	...
	print('字典的键不存在2') #字典的键不存在2
except NameError:
	print('这个变量不存在3') #这个变量不存在3
except:  #兜底
	print('有异常错误4') #有异常错误4
